...
// hallucinated or not.
async function hallucinationGrader(state: AdaptiveRagGraphState) {
...
// or not.
async function answerGrader(state: AdaptiveRagGraphState) {
...
const webSearch = async (state: AdaptiveRagGraphState) => {
...
const createModel = async (state: AdaptiveRagGraphState) => {
...
const generate = async (state: AdaptiveRagGraphState) => {
...
const routeQuestion = async (state: AdaptiveRagGraphState) => {
...
const decideToGenerate = async (state: AdaptiveRagGraphState) => {
...
const gradeGeneratedDocumentAndQuestion = async (state: AdaptiveRagGraphState) => {
